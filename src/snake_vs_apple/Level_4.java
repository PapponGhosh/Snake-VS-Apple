...
public class Level_4 extends JPanel implements ActionListener{
	...
	ImageIcon bg = new ImageIcon("all background//night field.png");
	...
	ImageIcon right_head = new ImageIcon("white snake head//right head.png");
	ImageIcon left_head = new ImageIcon("white snake head//left head.png");
	ImageIcon up_head = new ImageIcon("white snake head//up head.png");
	ImageIcon down_head = new ImageIcon("white snake head//down head.png");
	
	ImageIcon body_horizontal = new ImageIcon("white snake body//horizontal body.png");
	ImageIcon body_vertical = new ImageIcon("white snake body//vertical body.png");
	
	
	Level_4(int score, int snake_running_time){
		this.score = score;
	...
	public void paint(Graphics g) {
		...
		g.drawImage(bg.getImage(), 0, 0, sw, sh, null);
		draw(g);
	}
	...
	public void draw(Graphics g) {
		if(running) {
			...
			for(int i=140; i<=800; i++) {
				if(i==140) {
					g.drawImage(pipe_left.getImage(), i, 76, os, os+6, null);
					g.drawImage(pipe_left.getImage(), i, 616, os, os+6, null);
				}
				else if(i==800) {
					g.drawImage(pipe_right.getImage(), i, 77, os , os+6, null);
					g.drawImage(pipe_right.getImage(), i, 617, os, os+6, null);
				}
				else {
					g.drawImage(pipe_middle_h.getImage(), i, 80, null);
					g.drawImage(pipe_middle_h.getImage(), i, 620, null);
				}
			}
	...
	public void newApple() {
		...
		while(true) {
			if( (ay>=160 && ay<=540 && (ax==100 || ax==400 || ax==600 || ax==880)) || (ax>=140 && ax<=800 && (ay==80 || ay==620)) || (ay<=20)) {
				ax = random.nextInt((int)(sw/os))*os;
				ay = random.nextInt((int)(sh/os))*os;
			}
			else
